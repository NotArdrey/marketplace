...
<div class="registration-right">
    <div class="registration-right-container">
        ...
        <form action="../crud/generate_code.php" method="POST" id="registration-form">
            <div class="form-row">
                <input type="text" name = "first_name" placeholder="First Name" class="registration-input-box"required>
            ...
            <div class="special-form-row">
                ...
                <input type="text" name = "contact_number" placeholder="Contact Number" class="registration-input-box"required>
            </div>
            <div class="form-row">
                <input type="password" name = "password" placeholder="Password" class="registration-input-box"required>
                <input type="password" name = "confirm_password"placeholder="confirm password" class="registration-input-box"required>
            </div>       
