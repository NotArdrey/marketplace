...
function sendemail_code($first_name, $email, $token_pass) {
    ...
    try {
        ...
        $mail->Body    = "Hi $first_name,<br>Please click the link below to change your password:<br><a href='http://localhost/marketplace/pages/change_password.php?token_pass=". urlencode($token_pass) ."'>Verify Email</a>";
